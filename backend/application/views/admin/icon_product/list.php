                    ...
                    <?php  if(isset($error)){ echo $error; }
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <a class="pull-right" href="<?php echo site_url("admin/add_header_products"); ?>"><?php echo $this->lang->line("ADD");?></a>                                    
                                </div><!-- /.box-header -->
                                           ...
                                           <?php foreach($products as $product){ ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><div class="btn-group">
                                                        <?php echo anchor('admin/edit_header_products/'.$product->product_id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
                                                        <?php echo anchor('admin/delete_header_product/'.$product->product_id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
