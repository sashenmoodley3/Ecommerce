                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <!--a class="pull-right btn btn-primary" href="<?php echo site_url("admin/addpage_app"); ?>">ADD NEW PAGE</a--><br>
                                    <div class="toolbar">
                                                <br>           
                                    </div>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-left"><?php echo $this->lang->line("Page Slug");?></th>
                                            ...
                                            <tbody>
                                                <?php foreach($allpages as $allpage){ ?>
                                                    <tr>
                                                        <td class="text-left"><?php echo $allpage->id; ?></td>
                                                        <td class="text-left"><?php echo $allpage->pg_title; ?></td>
                                                        <td class="text-left"><?php echo $allpage->pg_slug; ?></td>
