                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo "Add Page";?></h4>
                                    <div class="row" style="margin-top:50px">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" name="page_title" class="form-control" placeholder="<?php echo $this->lang->line("Page Title");?>" value=""/>
                                                <input type="hidden" name="addpageapp" class="form-control" placeholder="Page id" value="addpageapp"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty" id="sample">
                                                <textarea   name="page_descri" id="page_descri" class="form-control " placeholder="<?php echo $this->lang->line("Place some text here");?>"></textarea>
...
<script type="text/javascript">
    ...
    bkLib.onDomLoaded(function() {
        new nicEditor({fullPanel : true}).panelInstance('page_descri');
    });
    //]]>
</script>
</html>