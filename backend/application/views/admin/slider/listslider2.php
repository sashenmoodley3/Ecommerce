                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Main Slider");?></h4>
                                    <a class="pull-right btn btn-primary" href="<?php echo site_url("admin/addslider"); ?>"><?php echo $this->lang->line("ADD");?></a>
                                    <div class="toolbar">
...
<!--                                                    <th class="text-left"><?php echo $this->lang->line("Slider Url");?></th>-->
...
<!--                                                    <th class="text-left"><?php echo $this->lang->line("Slider Url");?></th>-->
                                            ...
                                            <tbody>
                                                <?php foreach($allslider as $bus){ ?>
                                                    <tr>
                                                        <td class="text-left"><?php echo $bus->slider_title; ?></td>
<!--                                                        <th class="text-left"><?php echo $bus->slider_url; ?></td>-->
                                                        <td class="text-left" align="center"><div class="cat-img" style="width: 500px;"><img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'/uploads/sliders/'.$bus->slider_image ?>" /></div></td> 
                                                        <th class="text-left"><?php if($bus->slider_status=="1"){echo "Active";}else{echo "DeActive";} ?></td>  
