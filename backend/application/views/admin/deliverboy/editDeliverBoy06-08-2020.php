                                        ...
                                        <div class="row"  style="margin-top:50px">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="number" required name="user_phone" readonly value="<?=$deliverdata->user_phone?>" id="user_phone" class="form-control"  placeholder="Phone Number"/>
                                         ...
                                         <div class="row"  style="margin-top:50px">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="password" required name="user_password" value="<?=$deliverdata->user_password?>" id="user_password" class="form-control"  placeholder="Password"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top:50px" >
                                            <div class="col-md-12">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <textarea name="deliverboy_description" class="textarea"  id="editor" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;" maxlength="1250"><?=$deliverdata->deliverboy_description?></textarea>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
