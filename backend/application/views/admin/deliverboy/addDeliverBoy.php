                                    ...
                                    <div class="row"  style="margin-top:50px">
										<div class="col-md-3">
											<div class="form-group label-floating is-empty">
												...
												<input type="text" required name="user_country" id="user_country" class="form-control"  placeholder="Country"/>
										...
										<div class="col-md-3">
											<div class="form-group label-floating is-empty">
												...
												<input type="text" required name="user_state" id="user_state" class="form-control"  placeholder="Province"/>
										...
										<div class="col-md-3">
											<div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" required name="user_city" id="user_city" class="form-control"  placeholder="city"/>
										...
										<div class="col-md-3">
											<div class="form-group label-floating is-empty">
												...
												<input type="text" required name="user_pincode" id="user_pincode" class="form-control"  placeholder="Pincode"/>
											<span class="material-input"></span></div>
										</div>
									</div>
									...
									<div class="row" style="margin-top:50px" >
										<div class="col-md-6">
											<div class="form-group label-floating is-empty">
												...
												<textarea name="deliverboy_address" class="textarea"  id="editor" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;" maxlength="1250"></textarea>
											<span class="material-input"></span></div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group label-floating is-empty">
												...
												<textarea name="deliverboy_description" class="textarea"  id="editor" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd;" maxlength="1250"></textarea>
											<span class="material-input"></span></div>
										</div>
									</div>
