                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Product Title"); ?>
                                            : *</label>
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="hidden" id="pro_var_id" name="pro_var_id" value="<?= $product->pro_var_id; ?>">
                                                <span class="material-input"></span></div>
                                            <div class="well" id="result" style="display:none;"></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Deal Price"); ?>
                                            : *</label>
                                        <div class="col-md-9">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input type="text" id="deal_price" name="deal_price" class="form-control"
                                                       value="<?= $product->deal_price; ?>"
                                                       placeholder="<?php echo $this->lang->line("Deal Price"); ?>"/>
                                                <span class="material-input"></span></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Start From"); ?>
                                            : *</label>
                                        <div class="col-md-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <h4 class="card-title"><?php echo $this->lang->line("Start Date"); ?>
                                                        : *</h4>
                                                    <div class="form-group">
                                                        <label class="label-control"></label>
                                                        <input type="text" name="start_date"
                                                               value="<?= $product->start_date; ?>" id='txtDate'
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" name="start_time"
                                                               value="<?= $product->start_time; ?>" placeholder="00.00"
                                    ...
                                    <div class="row">
                                        <label class="col-md-3 label-on-left"><?php echo $this->lang->line("End To"); ?>
                                            : *</label>
                                        <div class="col-md-4">
                                            <div class="card">
                                                <div class="card-header card-header-icon" data-background-color="rose">
                                                ...
                                                <div class="card-content">
                                                    <h4 class="card-title"><?php echo $this->lang->line("End Date"); ?>:
                                                        *</h4>
                                                    <div class="form-group">
                                                        <label class="label-control"></label>
                                                        <input type='text' id='txtDate2' name="end_date"
                                                               class="form-control"
                                                               value="<?= $product->end_date; ?>" placeholder="00"
                                                               readonly="">
                                                        <span class="material-input"></span></div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type='Time' name="end_time"
                                                               class="form-control datepicker"
                                                               value="<?= $product->end_time; ?>" placeholder="00"/>
                                                        <span class="material-input"></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group form-button">
                                                <input type="submit" name="addcatg"
                                                       value="<?php echo $this->lang->line("Edit Product"); ?>"
...
<!--   Core JS Files   -->
<script src="<?php echo base_url($this->config->item('new_theme')); ?>/ckeditor/ckeditor.js"
