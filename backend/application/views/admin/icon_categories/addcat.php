                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="text-input form-control" name="parent">
                                                ...
                                                <?php  
                                                    ...
                                                    $q = $th->db->query("SELECT a.*, Deriv1.count FROM `header_categories` a  LEFT OUTER JOIN (SELECT `parent`, COUNT(*) AS count FROM `categories` GROUP BY `parent`) Deriv1 ON a.`id` = Deriv1.`parent` WHERE a.`parent`=" . $parent);
                                                    $rows = $q->result();
