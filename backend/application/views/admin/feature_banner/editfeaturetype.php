                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo "Edit Type";?></h4>
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo "Name";?>: *</label>
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input required type="text" name="type_name" class="form-control" placeholder="<?php echo "Name";?>" value="<?php echo $slider->type_name; ?>"/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" name="saveslider" value="<?php echo "Edit";?>" class="btn btn-fill btn-rose" >                                                </div>
                                            </div>
                                        </div>
                                </div>
                            </div>
