                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo "Feature Brand Slider Type";?></h4>
                                    <a class="pull-right btn btn-primary" href="<?php echo site_url("admin/add_feature_Banner_type"); ?>"><?php echo $this->lang->line("ADD");?></a>
                                    <div class="toolbar">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th class="text-left"><?php echo "Sr";?></th>
                                            ...
                                            <tbody>
                                                <?php $sr = 1; foreach($alltype as $bus){ 
                                                    ?>
                                                    <tr>
                                                        <td class="text-left"><?php echo $sr++; ?></td>
                                                        <td class="text-left"><?php echo $bus->type_name; ?></td>
                                                       
                                                        <td class="td-actions text-left"><div class="">
                                                            <?php echo anchor('admin/edit_feature_banner_type/'.$bus->type_id,  '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_feature_banner_type/'.$bus->type_id,  '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
