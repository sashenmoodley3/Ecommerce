                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input required type="text" name="type_name" class="form-control" placeholder="<?php echo "Name";?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input required type="submit" name="addslidertype" value="<?php echo "ADD";?>" class="btn btn-fill btn-rose" >                                                </div>
                                            </div> 
                                        </div>
                                </div>
                            </div>
