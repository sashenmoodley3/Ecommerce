...
<?php   
    $width      =   0;
    $height  =   0;
    if($slider->image_type == 1 && $slider->banner_type == 3){
        $width = '750';
        $height = '250';
    }
    elseif($slider->image_type == 0 && $slider->banner_type == 3){
        $width = '1395';
        $height = '200';
    }
    elseif($slider->image_type == 0 && $slider->banner_type == 1){
        $width = '560';
        $height = '378';
    }
    elseif($slider->image_type == 1 && $slider->banner_type == 1){
        $width = '275';
        $height = '184';
    }
    elseif(($slider->image_type == 1 || $slider->image_type == 0) && $slider->banner_type == 2){
        $width = '480';
        $height = '360';
    }
    elseif(($slider->image_type == 1 || $slider->image_type == 0) && $slider->banner_type == 4){
        $width = '1130';
        $height = '400';
    }  
?>      
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("Add Banner");?></h4>
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <select required name="slider_title" class="form-control" required>
                                                        ...
                                                        <?php foreach($q as $v){ ?>
                                                        <option <?php if($slider->slider_title == $v->type_id){echo "Selected";} ?> value="<?=$v->type_id?>"> <?=$v->type_name?> </option>
                                                        <?php } ?> 
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <option value="1" <?=$slider->image_type == 1 ? 'selected' : ''?>> <?php echo $this->lang->line("Small");?>  </option>
                                                    <option value="0" <?=$slider->image_type == 0 ? 'selected' : ''?>> <?php echo $this->lang->line("FullSize");?>  </option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <option value="1" <?=$slider->banner_type == 1 ? 'selected' : ''?>> <?php echo $this->lang->line("4 Small + 1 Big Banner");?>   </option>
                                                    <option value="2" <?=$slider->banner_type == 2 ? 'selected' : ''?>> <?php echo $this->lang->line("4 Small Banner");?>  </option>
                                                    <option value="3" <?=$slider->banner_type == 3 ? 'selected' : ''?>> <?php echo $this->lang->line("3 Small + 1 Big Banner");?>  </option>
                                                    <option value="4" <?=$slider->banner_type == 4 ? 'selected' : ''?>> <?php echo $this->lang->line("1 Slider Big Banner");?>  </option>
                                                    <option value="5" <?=$slider->banner_type == 5 ? 'selected' : ''?>> <?php echo $this->lang->line("1 Big Banner");?>  </option>
                                                </select>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 label-on-left"><?php echo $this->lang->line("Image");?> <span id='sizeof'>(Size - <?=$width?>*<?=$height?>)</span>(<?=$this->config->item('slider_file_size')/1024 ?>KB)* : </label>
                                            <div class="col-md-9">
                                                <legend></legend>
                                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                    ...
                                                    <div class="fileinput-new thumbnail">
                                                        <img width="100%" height="100%" src="<?php echo $this->config->item('base_url').'uploads/sliders/'.$image ?>">
                                                    </div>
                                                ...
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                        <select class="text-input form-control" name="sub_cat" id="sub_cat">
                                                            <?php  if($slider->sub_type == 'category'){ ?>
                                                                <option value="<?php echo $slider->sub_cat;?>"><?php echo $slider->cat_title;?></option>
                                                            <?php } else{
                                                                echo '<option value="">'.$this->lang->line("Select Sub Category").'</option>';
                                                            }
                                                ...
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                        <select  class="selectpicker"  name="brand" id="brand">
                                                            <?php  if($slider->sub_type == 'brand'){ ?>
                                                                <option value="<?php echo $slider->sub_cat;?>"><?php echo $slider->brand_title;?></option>
                                                            <?php } else{
                                                                echo '<option value="">'.$this->lang->line("Select Brand").'</option>';
                                                            }  
                                                ...
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                        <select class="selectpicker" name="product" id="product">
                                                            <?php  if($slider->sub_type == 'product'){ ?>
                                                                <option value="<?php echo $slider->sub_cat;?>"><?php echo $slider->product_name;?></option>
                                                            <?php } else{
                                                                echo '<option value="">'.$this->lang->line("Select Product").'</option>';
                                                            } 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" name="saveslider" value="<?php echo $this->lang->line("Add Slider");?>" class="btn btn-fill btn-rose edit-curd" >                                                </div>
                                            </div>
                                        </div>
                                </div>
                            </div>
