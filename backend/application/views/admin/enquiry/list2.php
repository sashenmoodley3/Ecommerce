                                ...
                                <div class="card-content">
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th class="text-left"><?php echo "Sr.No";?></th>
                                                    <th class="text-left"><?php echo $this->lang->line("Name");?></th>
                                                    <th class="text-left"><?php echo $this->lang->line("Email");?></th>
                                                    <th class="text-left"><?php echo "Mobile Number";?></th>
                                                    <th class="text-left"><?php echo $this->lang->line("Message");?></th>
                                                    <th class="text-left"><?php echo "Enquiry Date";?></th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach($enquiries as $enquiry){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left"><?php echo $enquiry->phone; ?></td>
                                                        <td class="text-left"><?php echo $enquiry->message; ?></td>
                                                        <td class="text-left"><?php echo $enquiry->created_at; ?></td>
                                                        <td class="td-actions text-left"><div class="btn-group">
<!--                                                            --><?php //echo anchor('admin/edit_socity/'.$enquiry->id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
//                                                                <i class="material-icons">edit</i>
//                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_enquiry/'.$enquiry->id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
