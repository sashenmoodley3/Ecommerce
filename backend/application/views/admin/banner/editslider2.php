                                    ...
                                    <h4 class="card-title"><?php echo $this->lang->line("Add Banner");?></h4>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" required name="slider_title" class="form-control" placeholder="<?php echo $this->lang->line("Add Banner");?>" value="<?php echo $slider->slider_title; ?>"/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" required name="emp_fullname" class="form-control" placeholder="<?php echo $this->lang->line("Slider Url");?>"  value="<?php echo $slider->slider_url;?>"/>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group form-button">
                                                    <input type="submit" name="saveslider" value="<?php echo $this->lang->line("Add Banner");?>" class="btn btn-fill btn-rose edit-curd" >                                                </div>
                                            </div>
                                        </div>
                                </div>
                            </div>
