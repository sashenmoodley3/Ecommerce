        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    ?>
                            <?php
                                $q = $this->db->query("SELECT * FROM `language_setting`" );
                                $rows = $q->result_array();
                            ?>
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title"><?php echo $this->lang->line("language Setting");?></h4>
                                        ...
                                        <?php foreach($rows as $result){
                                            ...
                                            $status         =   !empty($result['status']) ? 'checked="checked"':'';
                                                echo '                                            
                                                        <div class="col-md-9">
                                                            <div class="form-group label-floating is-empty">
                                                                <label class="control-label"></label>
                                                                <input type="radio" name="status" value="'.$language_name.'@1" '.$status.' id="status" class="form-control" style="width: 20%;float:left; height:19px;"/>
                                                                <label class="col-md-6" for="status">'.$this->lang->line("$language_name").'</label>
