                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q = $this->db->query("Select * from sms_template WHERE  type = 1 AND status = 1 ")->row();
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q2 = $this->db->query("Select * from sms_template WHERE  type = 2 AND status = 1 ")->row();?>
                                <div class="card">
                                    <div class="card-header card-header-icon" data-background-color="rose">
                                        <i class="material-icons">today</i>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q3 = $this->db->query("Select * from sms_template WHERE  type = 3 AND status = 1 ")->row();?>
                                <div class="card">
                                    <div class="card-header card-header-icon" data-background-color="rose">
                                        <i class="material-icons">today</i>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q4 = $this->db->query("Select * from sms_template WHERE  type = 4 AND status = 1")->row();?>
                                <div class="card">
                                    <div class="card-header card-header-icon" data-background-color="rose">
                                        <i class="material-icons">today</i>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q5 = $this->db->query("Select * from sms_template WHERE  type = 5 AND status = 1 ")->row();?>
                                <div class="card">
                                    <div class="card-header card-header-icon" data-background-color="rose">
                                        <i class="material-icons">today</i>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q6 = $this->db->query("Select * from sms_template WHERE  type = 6 AND status = 1")->row();?>
                                <div class="card">
                                    <div class="card-header card-header-icon" data-background-color="rose">
                                        <i class="material-icons">today</i>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q7 = $this->db->query("Select * from sms_template WHERE  type = 7 AND status = 1")->row();?>
                                <div class="card">
                                    <div class="card-header card-header-icon" data-background-color="rose">
                                        <i class="material-icons">today</i>
                                    </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php  $q8 = $this->db->query("Select * from sms_template WHERE  type = 8 AND status = 1")->row();?>
                                <div class="card">
                                    <div class="card-header card-header-icon" data-background-color="rose">
                                        <i class="material-icons">today</i>
                                    </div>
