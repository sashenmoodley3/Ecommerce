...
<!--                                                    <th><?php echo $this->lang->line("Socity Name :");?></th>-->
                                            ...
                                            <tbody>
                                                <?php foreach($pincodes as $pincode){ ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $pincode->pincode_id; ?></td>
<!--                                                        <td><?php echo $pincode->socity_name; ?></td>-->
                                                        <td><?php echo $pincode->pincode; ?></td>
                                                        <td><?php echo $pincode->delivery_charge; ?></td>
                                                        <td><?php if(!empty($pincode->free_delivery_amount)){echo $pincode->free_delivery_amount; }else{ echo "0";}?></td>
                                                        <td><?php echo $pincode->delivery_days; ?></td>
                                                        <td class="td-actions text-right"><div class="btn-group">
                                                            <?php echo anchor('admin/edit_pincode/'.$pincode->pincode_id, '<button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                                <i class="material-icons">edit</i>
                                                            </button>', array("class"=>"")); ?>

                                                            <?php echo anchor('admin/delete_pincode/'.$pincode->pincode_id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
