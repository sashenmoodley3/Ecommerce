...
$(document).delegate(".mega-menu-title", "click", function(e){
...
$(document).delegate('.mega-menu-category .nav > li.view-more', "click", function(e){
...
// $('.mega-container').mouseenter(function(){
//     $('.mega-menu-category').slideToggle();
// }).mouseleave(function() {
//     $('.mega-menu-category').slideToggle();
// });
