        ...
        jQuery(document).ready(function() {
            ...
            return this.each(function() {
                ...
                eval("var	a = {" + jQuery(this).attr("rel") + "}"), relOpts = a, jQuery(this).is(".cloud-zoom") ? (opts = jQuery.extend({}, jQuery.fn.CloudZoom.defaults, options), opts = jQuery.extend({}, opts, relOpts), jQuery(this).css({
                    ...
                    //console.log(e);
                    return jQuery("#" + e.useZoom).data("zoom").destroy(), jQuery("#" + e.useZoom).attr("href", A.data.attr("href")), jQuery("#" + e.useZoom + " img").attr("src", A.data.data("relOpts").smallImage), jQuery("#" + e.useZoom + " img").attr("data-zoom", A.data.attr("href")), jQuery("#" + A.data.data("relOpts").useZoom).CloudZoom(), !1
                }))
            }), this
        }
